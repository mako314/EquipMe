            ...
            <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                    ...
                    <div class="flex justify-center">
                        <button class="inline-flex text-white bg-amber-500 border-0 py-2 px-6 focus:outline-none hover:bg-gray-600 rounded text-lg" onClick={handleClick2}>Rent</button>
                        <button class="ml-4 inline-flex text-white bg-amber-500 border-0 py-2 px-6 focus:outline-none hover:bg-gray-600 rounded text-lg" onClick={handleClick}>Info</button>
                    ...
                    <div class="flex flex-wrap w-full">
                        <div class="lg:w-2/5 md:w-1/2 md:pr-10 md:py-6">
                            <div class="flex relative pb-12">
                                ...
                                <div class="flex-shrink-0 w-10 h-10 rounded-full bg-amber-500 inline-flex items-center justify-center text-white relative z-10">
                                ...
                                <div class="flex-grow pl-4">
                                    ...
                                    <p class="leading-relaxed">Create an account or a listing.</p>
                                </div>
                            </div>
                            <div class="flex relative pb-12">
                                <div class="h-full w-10 absolute inset-0 flex items-center justify-center">
                                ...
                                <div class="flex-grow pl-4">
                                    ...
                                    <p class="leading-relaxed">Book equipment, or connect with professionals looking to rent.</p>
                                </div>
                            </div>
                            <div class="flex relative pb-12">
                                <div class="h-full w-10 absolute inset-0 flex items-center justify-center">
                                ...
                                <div class="flex-grow pl-4">
                                    ...
                                    <p class="leading-relaxed">Sign a rental agreement that's been officiated by our team of lawyers.</p>
                                </div>
                            </div>
                            <div class="flex relative">
                                ...
                                <div class="flex-grow pl-4">
                                    ...
                                    <p class="leading-relaxed">Pickup your equipment at an agreed upon location, or have it delivered to your worksite!</p>
                                </div>
                            </div>
                        </div>
                        <img class="lg:w-3/5 md:w-1/2 object-cover object-center rounded-lg md:mt-0 mt-12" src="https://www.westernstatescat.com/wp-content/uploads/2016/12/Jackson-Team.jpg" alt="step" />
                    </div>
                </div>
            </section>
        </div>
