            ...
            <div class="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
                ...
                <div class="col-span-4 sm:col-span-9">
                    <div class="bg-white shadow rounded-lg p-6">
                        ...
                        <p class="text-gray-700"> Short biography about the company?
                        </p>
                        ...
                        <div class="flex justify-center items-center gap-6 my-6">
                            <span class="text-gray-700 hover:text-orange-600" aria-label="Visit TrendyMinds LinkedIn" href=""
                            ...
                            <span class="text-gray-700 hover:text-orange-600" aria-label="Visit TrendyMinds YouTube" href=""
                            ...
                            <span class="text-gray-700 hover:text-orange-600" aria-label="Visit TrendyMinds Facebook" href=""
                            ...
                            <span class="text-gray-700 hover:text-orange-600" aria-label="Visit TrendyMinds Instagram" href=""
                                target="_blank"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="h-6">
                                    <path fill="currentColor"
                            ...
                            <span class="text-gray-700 hover:text-orange-600" aria-label="Visit TrendyMinds Twitter" href=""
                        ...
                        <div class="mb-6">
                            ...
                            <p class="mt-2">some of their featured listings here maybe?
                            </p>
                        </div>
                        <div class="mb-6">
                            <div class="flex justify-between">
...
{/* <div>
<div className="card__title">Owner: {name}</div>
