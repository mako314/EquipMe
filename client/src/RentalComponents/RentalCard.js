...
function RentalCard({ equipmentName, rentalDates, renterFirstName, renterLastName, location, ownerEmail, ownerName }) {
    ...
    return (
        ...
        <div class="flex items-center px-6 py-3 bg-gray-900">
            ...
            <h1 class="mx-3 text-lg font-semibold text-white">{equipmentName}</h1>
        </div>

        <div class="px-6 py-4">
            <h1 class="text-xl font-semibold text-gray-800 dark:text-white">{ownerName}</h1>

            <p class="py-2 text-gray-700 dark:text-gray-400"> {rentalDates} </p>
            ...
            <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                ...
                <h1 class="px-2 text-sm">{renterFirstName} {renterLastName}</h1>
            </div>
            ...
            <div class="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                ...
                <h1 class="px-2 text-sm">{ownerEmail}</h1>
            </div>
        </div>
    </div>
