...
function RentalAgreementCard({ equipmentName, rentalStart, rentalEnd, renterFirstName, renterLastName, location, ownerEmail, ownerFirstName, ownerLastName, cartName, quantity, rentalDelivery, rentalDeliveryAddress, rentalRevisions, rentalStatus,rentalCreatedAt, rentalUpdatedAt }) {
    ...
    return (
            ...
            <div class="w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-lg mb-4 mt-3 mx-2">
        <div class="px-6 py-3 bg-gray-900 flex items-center">
            ...
            <h2 class="text-lg font-semibold text-white mx-3">Cart: {cartName} <br></br>Item: {equipmentName} x {quantity}</h2>
        </div>

        <div class="px-6 py-4">
            <h1 class="text-xl font-semibold">{renterFirstName} {renterLastName}</h1>
            <p class="py-2">{rentalStart} to {rentalEnd}</p>
            
            {/* <!-- Flex container for each detail line --> */}
            <div class="flex items-center text-gray-700 my-2">
                ...
                <h3 class="text-sm px-2">{rentalDelivery === true ? `Scheduled for Delivery to ${rentalDeliveryAddress}` : "Delivery not Scheduled"}</h3>
            </div>
            ...
            <div class="flex items-center text-gray-700 my-2">
                ...
                <h3 class="text-sm px-2">Owner: {ownerFirstName} {ownerLastName}</h3>
            </div>
            ...
            <div class="flex items-center text-gray-700 my-2">
                ...
                <h3 class="text-sm px-2">{location}</h3>
            </div>
            ...
            <div class="flex items-center text-gray-700 my-2">
                ...
                <h3 class="text-sm px-2">Email: {ownerEmail}</h3>
            </div>
            ...
            <div class="flex items-center text-gray-700 my-2">
                ...
                <h3 class="text-sm px-2">Created At: {rentalCreatedAt}</h3>
            </div>
            ...
            <div class="flex items-center text-gray-700 my-2">
                ...
                <h3 class="text-sm px-2">Updated At: {rentalUpdatedAt}</h3>
            </div>
            ...
            <div class="flex items-center text-gray-700 my-2">
                ...
                <h3 class="text-sm px-2">Revisions: {rentalRevisions}</h3>
            </div>
            ...
            <div class="flex items-center text-gray-700 my-2">
                ...
                <h3 class="text-sm px-2">Status: {rentalStatus}</h3>
            </div>
...
{/* <div class="w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-lg mb-4 mt-3 mx-2">
    <div class="px-6 py-3 bg-gray-900 flex items-center">
        ...
        <h1 class="text-lg font-semibold text-white mx-3">Cart: {cartName} <br>Item: {equipmentName} x {quantity}</h1>
    </div>
    ...
    <div class="px-6 py-4">
        ...
        <div class="flex items-center text-gray-700 my-2">
            ...
            <h1 class="text-sm px-2">{rentalDelivery === true ? `Scheduled for Delivery to ${rentalDeliveryAddress}` : "Delivery not Scheduled"}</h1>
        </div>
        ...
        <div class="flex items-center text-gray-700 my-2">
            ...
            <h1 class="text-sm px-2">Owner: {ownerFirstName} {ownerLastName}</h1>
        </div>
        ...
        <div class="flex items-center text-gray-700 my-2">
            ...
            <h1 class="text-sm px-2">{location}</h1>
        </div>
        ...
        <div class="flex items-center text-gray-700 my-2">
            ...
            <h1 class="text-sm px-2">Email: {ownerEmail}</h1>
        </div>
        ...
        <div class="flex items-center text-gray-700 my-2">
            ...
            <h1 class="text-sm px-2">Revisions: {rentalRevisions}</h1>
        </div>
        ...
        <div class="flex items-center text-gray-700 my-2">
            ...
            <h1 class="text-sm px-2">Status: {rentalStatus}</h1>
        </div>
        ...
        <div class="flex items-center text-gray-700 my-2">
            ...
            <h1 class="text-sm px-2">Updated At: {rentalUpdatedAt}</h1>
        </div>
    </div>
</div> */
}