    ...
    return (
        ...
        <div className="px-6 py-4">
            ...
            <div className="flex items-center text-gray-700 my-2">
                ...
                <h3 className="text-sm px-2">{location}</h3>
            </div>
            ...
            <div className="flex items-center text-gray-700 my-2">
                ...
                <h3 className="text-sm px-2">Created At: {rentalCreatedAt}</h3>
            </div>
            ...
            <div className="flex items-center text-gray-700 my-2">
                ...
                <h3 className="text-sm px-2">Updated At: {rentalUpdatedAt}</h3>
            </div>
...
{/* <div className="w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-lg mb-4 mt-3 mx-2">
    <div className="px-6 py-3 bg-gray-900 flex items-center">
        ...
        <h1 className="text-lg font-semibold text-white mx-3">Cart: {cartName} <br>Item: {equipmentName} x {quantity}</h1>
    </div>
    ...
    <div className="px-6 py-4">
        ...
        <div className="flex items-center text-gray-700 my-2">
            ...
            <h1 className="text-sm px-2">{rentalDelivery === true ? `Scheduled for Delivery to ${rentalDeliveryAddress}` : "Delivery not Scheduled"}</h1>
        </div>
        ...
        <div className="flex items-center text-gray-700 my-2">
            ...
            <h1 className="text-sm px-2">Owner: {ownerFirstName} {ownerLastName}</h1>
        </div>
        ...
        <div className="flex items-center text-gray-700 my-2">
            ...
            <h1 className="text-sm px-2">{location}</h1>
        </div>
        ...
        <div className="flex items-center text-gray-700 my-2">
            ...
            <h1 className="text-sm px-2">Email: {ownerEmail}</h1>
        </div>
        ...
        <div className="flex items-center text-gray-700 my-2">
            ...
            <h1 className="text-sm px-2">Revisions: {rentalRevisions}</h1>
        </div>
        ...
        <div className="flex items-center text-gray-700 my-2">
            ...
            <h1 className="text-sm px-2">Status: {rentalStatus}</h1>
        </div>
        ...
        <div className="flex items-center text-gray-700 my-2">
            ...
            <h1 className="text-sm px-2">Updated At: {rentalUpdatedAt}</h1>
        </div>
    </div>
</div> */
}